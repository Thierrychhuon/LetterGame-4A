...
private JFrame frame;
	...
	private JPanel buildContentPane(){
		...
		JButton passer=new JButton("Passed");
		...
		JButton voler=new JButton("Steal");
		...
		JButton modifier=new JButton("custom");
		...
		String printletter="";
		potcommun.setText(LetterPot.CommonPot.forEach(letter ->));
